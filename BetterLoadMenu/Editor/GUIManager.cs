...
namespace BetterLoadMenu.Editor
{
    public class GUIManager
    {
        ...
        private int shownEntries, totalEntries;
        ...
        void OnWindow(int id)
        {
            ...
            this.searchText = GUILayout.TextField(this.searchText, _textField);
            ...
            GUILayout.Label(String.Format("<size=10><color=orange>{0} total entries, {1} shown</color></size>", this.totalEntries, this.shownEntries), _label);
